...
class StudentsListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new StudentsListBuilder object.
   *
  ...
  public function render() {
    ...
    $build['summary']['#markup'] = $this->t('Total studentss: @total', ['@total' => $total]);
    return $build;
  }
  ...
  public function buildRow(EntityInterface $entity) {
    /** @var \Drupal\student_entity\StudentsInterface $entity */
    $row['id'] = $entity->id();
